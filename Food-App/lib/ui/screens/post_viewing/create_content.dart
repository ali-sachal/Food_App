...
class _HealthPredictorState extends State<CreateContent> {
                            ...
                            Row(
                              children: [
                                Text(
                                  "Post a",
                                  style:
                                  TextStyle(color: Colors.orange).s(28).w(7),
                                ),
                              ],
                            ),
                            Row(
    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            children: [
              Image.asset( Images.goldModelImage,),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Divider(
            color: primaryColorWithOpacity, // Customize the color of the divider
